...
function [Metrics, Tracking, Params, P] = calculateMetrics_custom(Tracking, Params, P)
    ...
    Metrics.Movement.DistanceTraveled = sum(dist_frame) / Params.px2cm;  % total movement in cm
